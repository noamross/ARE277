...
nullclines(bvp(r=r,p=p,c=c,a=a),c(0,10),c(0,10),30,xlab="Fish stock (x)", ylab="Harvest rate (h)", colors=c("#45462f", "#45462f"), xaxs="i", yaxs="i", add=TRUE)
curve(p - sqrt(2*a*c/x), xlim=c(0,10), add=TRUE, n=500)

traj <- draw.traj(bvpDES, Pars=parms, tStart=0, tEnd=3, tCut=500, color="blue")

phasearrows(bvp(r=r,p=p,c=c,a=a),c(0,5),c(0,5),30, add=TRUE, n=500)
points(x0,y0)
